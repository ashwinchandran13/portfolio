                    ...
                    <div className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 text-black bg-gray-100 rounded-lg md:p-10 md:grid-cols-2 gap-x-12 dark:text-white dark:bg-dark-100">
                        ...
                        <motion.div variants={stagger} initial="initial" animate="animate">
                            ...
                            <motion.div variants={fadeInUp} className="flex justify-center my-4 space-x-3">
                                <a href={github_url} target="_blank" className="flex items-center px-4 py-2 space-x-3 text-lg bg-gray-200 dark:bg-dark-200" rel="noreferrer">
                                    <AiFillGithub /><span>Github</span>
                                </a>
                                {deployed_url && (
                                    <a href={deployed_url} target="_blank" className="flex items-center px-4 py-2 space-x-3 text-lg bg-gray-200 dark:bg-dark-200" rel="noreferrer">
